...
SCRIPT_R=/home/datawork-ihpe/Pearl_Oyster_Colour_BS_Seq/00_scripts/17_methylkit_CHG_differential_methylation.R

Rscript --vanilla $SCRIPT_R > ${SCRIPT_FOLDER}/17_methylkit_CHG_differential_methylation.out
