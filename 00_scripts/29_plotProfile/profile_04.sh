...
plotProfile -m Index_1.3-R-180_R1_paired_bismark_bt2_pe.deduplicated.bam.sam_sorted_clean.bam_02_matrix.mat.gz -out Index_1.3-R-180.pdf --plotTitle "Index_1.3-R-180" --plotHeight 10 --plotWidth 10
