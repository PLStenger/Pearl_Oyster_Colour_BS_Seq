...
plotProfile -m Index_22.2-J-7_R1_paired_bismark_bt2_pe.deduplicated.bam.sam_sorted_clean.bam_02_matrix.mat.gz -out Index_22.2-J-7.pdf --plotTitle "Index_22.2-J-7" --plotHeight 10 --plotWidth 10
