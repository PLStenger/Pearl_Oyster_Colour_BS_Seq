...
plotProfile -m Index_11.3-V-620_R1_paired_bismark_bt2_pe.deduplicated.bam.sam_sorted_clean.bam_02_matrix.mat.gz -out Index_11.3-V-620.pdf --plotTitle "Index_11.3-V-620" --plotHeight 10 --plotWidth 10
