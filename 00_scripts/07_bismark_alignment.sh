...
DATADIRECTORY=/home/datawork-ihpe/Pearl_Oyster_Colour_BS_Seq/99_07_test_bismark
...
OUTPUT=/home/datawork-ihpe/Pearl_Oyster_Colour_BS_Seq/99_07_test_bismark
...
bismark -l 35 -n 0 -p 4 -q --genome $GENOME -1 $READS/Index_10.2-V-620_R1_paired.fastq.gz -2 $READS/Index_10.2-V-620_R2_paired.fastq.gz > $OUTPUT/Index_10.2-V-620.sam
